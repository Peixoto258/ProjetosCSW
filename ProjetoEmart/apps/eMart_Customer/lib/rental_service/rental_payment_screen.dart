    ...
    await FireStoreUtils().rentalOrderPlace(rentalOrderModel!, getTotalAmount()).then((value) {
      if (driverDetails!.companyId.isNotEmpty) {
        FireStoreUtils.sendFcmMessage('New Booking Arrive !'.tr(),
            '${MyAppState.currentUser!.firstName} ${MyAppState.currentUser!.lastName} has book your ${driverDetails!.firstName} ${driverDetails!.lastName} car', comapny!.fcmToken, ORDERREQUEST);
      } else {
        FireStoreUtils.sendFcmMessage(
            'New Booking Arrive !'.tr(), '${MyAppState.currentUser!.firstName} ${MyAppState.currentUser!.lastName} has book your car!', widget.driverDetails!.fcmToken, ORDERREQUEST);
      }
    });
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  Text(
                    "Subtotal".tr(),
                    style: const TextStyle(fontFamily: "Poppinsm", fontSize: 16),
                  ),
                  Text(
