...
enum DrawerSelectionEcommarce { Dashboard, Home, Wallet, dineIn, Cuisines, Search, Cart, Profile, Orders, MyBooking, chooseLanguage, termsCondition, privacyPolicy, Logout, LikedStore, LikedProduct }
