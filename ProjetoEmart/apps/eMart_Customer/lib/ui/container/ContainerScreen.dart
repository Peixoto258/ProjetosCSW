...
enum DrawerSelection { Dashboard, Home, Wallet, dineIn, Cuisines, Search, Cart, Profile, Orders, MyBooking, chooseLanguage, Logout, termsCondition, privacyPolicy, LikedStore, LikedProduct }
