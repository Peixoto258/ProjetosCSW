              ...
              child: Column(
                children: [
                  Container(
                      ...
                      child: Text(
                        'Remarks'.tr(),
                        style: TextStyle(fontFamily: 'Poppinssb', color: isDarkMode(context) ? const Color(0XFFD5D5D5) : const Color(0XFF2A2A2A), fontSize: 16),
                      )),
                  Container(
                      padding: const EdgeInsets.only(top: 10),
                      child: Text(
                        'Write remarks for Store'.tr(),
                        style: TextStyle(fontFamily: 'Poppinsr', color: isDarkMode(context) ? Colors.white70 : const Color(0XFF9091A4), letterSpacing: 0.5, height: 2),
                      ).tr()),
                  Container(
                      padding: const EdgeInsets.only(left: 20, right: 20, top: 20),
                      // height: 120,
