...
class _OrdersScreenState extends State<OrdersScreen> {
        ...
        child: Padding(
          ...
          child: GestureDetector(
              ...
              child: Column(children: [
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              orderModel.id,
                              style: TextStyle(fontSize: 18, color: isDarkMode(context) ? Colors.grey.shade200 : const Color(0XFF000000), fontFamily: "Poppinsm"),
                            ),
                          ],
                        ),
                        const SizedBox(
                            ...
                            itemBuilder: (context, index) {
                              return Padding(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    Row(
                                      children: [
                                        Text(orderModel.status.tr(), style: TextStyle(color: isDarkMode(context) ? Colors.grey.shade200 : const Color(0XFF555353), fontFamily: "Poppinsr")),
                                        ...
                                        Text(orderDate(orderModel.createdAt), style: TextStyle(color: isDarkMode(context) ? Colors.grey.shade200 : const Color(0XFF555353), fontFamily: "Poppinsr")),
                                      ],
                                    ),
                ...
                //         child: Text(
                //           'REORDER'.tr(),
                //           style: TextStyle(color: isDarkMode(context) ? const Color(0xffFFFFFF) : Colors.black, fontFamily: "Poppinsm", fontSize: 15),
                //         ),
                //       )),
                //   onTap: () {
  ...
  getPriceTotalText(CartProduct s) {
    ...
    return Text(
      ...
      style: TextStyle(fontSize: 20, color: isDarkMode(context) ? Colors.grey.shade200 : Color(COLOR_PRIMARY), fontFamily: "Poppinsm"),
    );
  }
}
