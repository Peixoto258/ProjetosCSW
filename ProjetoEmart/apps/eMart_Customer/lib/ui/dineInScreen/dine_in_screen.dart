              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Find your restaurant".tr(), style: TextStyle(fontSize: 24, color: isDarkMode(context) ? Colors.white : const Color(0xFF333333), fontFamily: "Poppinssb")).tr(),
                  ),
                  buildDineInTitleRow(
      ...
      child: Container(
        ...
        child: Align(
          ...
          child: Row(
            ...
            children: [
              Text(titleValue.tr(), style: TextStyle(color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontSize: 16, fontFamily: "Poppinsm")),
              isViewAll!
                  ? Container()
                  : GestureDetector(
                      onTap: () {
