                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Menus".tr(), style: const TextStyle(fontSize: 16, fontFamily: "Poppinsm")),
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Cuisines".tr(), style: TextStyle(color: isDarkMode(context) ? Colors.white : const Color(0xFF000000), fontSize: 16, fontFamily: "Poppinsm")),
                              ],
                            ),
                          ),
                          Padding(
    ...
    if (widget.vendorModel.reststatus == true) {
      ...
      return Container(
          ...
          child: Row(children: [
            ...
            Text("Close".tr(), style: TextStyle(fontFamily: "Poppinsm", fontSize: 16, letterSpacing: 0.5, color: Colors.redAccent))
          ]));
    }
  }
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () async {
                            ...
                            FireStoreUtils.sendFcmMessage(
                                'New Booking Request!'.tr(), '${MyAppState.currentUser!.firstName}' " has Request for Table Booking.", widget.vendorModel.fcmToken, BOOKREQUEST);
