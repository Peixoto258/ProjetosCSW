                ...
                child: Container(
                    ...
                    child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          Text(
                            "Services".tr(),
                            style: TextStyle(fontSize: 18, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF000000), fontFamily: "Poppinsm"),
                          ),
                          Container(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              width: 123,
                                              child:
                                                  Text(vendormodel.filters.keys.elementAt(index), textAlign: TextAlign.center, style: const TextStyle(color: Color(0XFF333333), fontFamily: "Poppinsl"))
                                                      .tr(),
                                            ),
                                          ],
                                        ),
