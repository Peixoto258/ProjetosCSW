...
//                 //           labelStyle: const TextStyle(fontSize: 16, fontFamily: "Poppinsm"),
//                 //           unselectedLabelStyle: const TextStyle(fontFamily: "Poppinsr"),
...
//           //             style: const TextStyle(fontFamily: "Poppinsm", color: Colors.white, fontSize: 16),
//           //           ).tr(),
//           //           const SizedBox(
//           //             width: 15,
//           //           ),
...
//                         style: const TextStyle(
//                             fontSize: 16, fontFamily: "Poppins", fontWeight: FontWeight.normal, letterSpacing: 0.5, color: Color(GREY_TEXT_COLOR)),
//                       ),
//                       Container(
...
//                     Text(
//                       productModel.name,
//                       style: const TextStyle(fontSize: 16, fontFamily: "Poppinssb", letterSpacing: 0.5, color: Color(0XFF2A2A2A)),
...
//                                 style: TextStyle(fontSize: 18, fontFamily: "Poppinsm", letterSpacing: 0.5, color: Color(COLOR_PRIMARY)),
//                               )
//                             : Column(
//                                 crossAxisAlignment: CrossAxisAlignment.start,
//                                 children: [
...
//                                     symbol + price.toDouble().toStringAsFixed(decimal),
//                                     style: const TextStyle(
//                                         fontFamily: "Poppinsm", letterSpacing: 0.5, color: Colors.grey, decoration: TextDecoration.lineThrough),
//                                   ),
//                                   Text(
...
//                       style: TextStyle(fontFamily: "Poppinsm", color: isDarkMode(context) ? const Color(0XFFa5a292) : const Color(0XFF5A5D6D)))
//                 ],
//               )),
//         ),
//         const SizedBox(
