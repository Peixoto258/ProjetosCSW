          ...
          Visibility(
              ...
              child: Positioned(
                  ...
                  child: InkWell(
                      ...
                      child: Text(
                        "SKIP".tr(),
                        style: const TextStyle(fontSize: 19, color: Color(0XFFFF683A), fontFamily: 'Poppinsm'),
                      )))),
          Visibility(
              visible: _currentIndex + 1 != _imageList.length,
              child: Positioned(
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          ...
          style: TextStyle(color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF333333), fontFamily: 'Poppinsm', fontSize: 20),
        ),
        ...
        Padding(
            ...
            child: Text(
              _subtitlesList,
              textAlign: TextAlign.center,
              style: TextStyle(color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0XFF333333), fontFamily: 'Poppinsl', height: 2, letterSpacing: 1.2, fontSize: 15),
            )),
