              ...
              Row(
                ...
                children: [
                  Text(
                    ...
                    style: const TextStyle(fontSize: 16, fontFamily: "Poppins", fontWeight: FontWeight.normal, letterSpacing: 0.5),
                  ),
                  Container(
                  ...
                  Text("valid till " + getDate(snapshot[index].expireOfferDate!.toDate().toString())!, style: const TextStyle(fontFamily: "Poppins", letterSpacing: 0.5))
                ],
              ),
            ],
          ),
                        ...
                        Center(
                          child: Container(
                              ...
                              child: const Text(
                                ...
                                style: TextStyle(fontFamily: 'Poppinsr', color: Color(0XFF9091A4), letterSpacing: 0.5, height: 2),
                              ).tr()),
                        ),
                        Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(fontFamily: "Poppinsm", fontWeight: FontWeight.w600, color: isDarkMode(context) ? const Color(0xffFFFFFF) : const Color(0xff333333), fontSize: 16),
                      ),
                    ],
                  )),
              const Padding(
              ...
              Visibility(
                ...
                child: Padding(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontFamily: "Poppinsm", fontWeight: FontWeight.w600, color: Color(COLOR_PRIMARY), fontSize: 16),
                  ),
                ),
              ),
              const Padding(
