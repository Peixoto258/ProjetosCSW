                            ...
                            onShowPicker: (context, currentValue) {
                              return showDatePicker(
                                  ...
                                  initialDate: widget.offerModel == null
                                      ? DateTime.now()
                                      : widget.offerModel!.expireOfferDate!
                                          .toDate(),
                  ...
                  if (_formKey.currentState?.validate() == false) {
                    ...
                    if (_mediaFiles.length > 0) {
                      ...
                      Reference upload = FirebaseStorage.instance
                          .ref()
                          .child(STORAGE_ROOT+'store/offerImages/$uniqueID'
                              '.png');
                    ...
                    mOfferModel.offerCode =
                        txtCouponCode.text.toString().trim();
                    mOfferModel.descriptionOffer = "";
                    mOfferModel.discountOffer =
                        txtAddPrice.text.toString().trim();
